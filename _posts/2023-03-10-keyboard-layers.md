...
All of this for me started in 2016, I was getting into college and
...
this means that we can assing the hold behavior  of the caps key to another function.
...
Control on Caps is really common on emacs, another popular editor, where most keybindgs use the Control key,
usually in some really weird and unconfortable way.
Even though I don't use emcas, we use Ctrl shorcuts all the time, to copy, paste, cut, new tab, print etc.
